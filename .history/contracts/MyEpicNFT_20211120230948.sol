...
contract MyEpicNFT is ERC721URIStorage {
    ...
    constructor() public ERC721("Munchkin Words", "MUNCH") {
    ...
    function makeAnEpicNFT() public {
        ...
        // Call the random color function
        string memory randomColor = pickRandomColor(newItemId); // Color
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        combinedWord,
                        '", "description": "A highly acclaimed collection of Munchkin Words.", "image": "data:image/svg+xml;base64,',
